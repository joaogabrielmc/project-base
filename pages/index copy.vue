    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="w-full max-w-md">
            <form @submit.prevent="login" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div class="mb-4"> <label class="block text-gray-700 text-sm font-bold mb-2" for="username"> Username
            ...
            <p class="text-center text-gray-700 text-xs"> Don't have an account? <router-link to="/register"
                    class="no-underline hover:underline text-blue-500">Register</router-link> </p>
        </div>
    </div>
</template>
